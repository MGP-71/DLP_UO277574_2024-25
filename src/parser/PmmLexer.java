...
public class PmmLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__33", "T__34", "T__35", "T__36", "T__37", "T__38", "WHITE_SPACE", 
			"ONE_LINE_COMMENT", "MULTIPLE_LINE_COMMENT", "ID", "INT_CONSTANT", "REAL_CONSTANT", 
			"REAL_CONSTANT_FLOATING_POINT", "REAL_CONSTANT_MANTISSA_EXPONENT", "CHAR_CONSTANT", 
			"CHAR"
		};
	}
